...
class BaseExceptionWrapperDto:
    ...
    def __init__(self, **kwargs):
        ...
        self.class_error = kwargs.get('class_error', '')
...
def handle_exception(exception,
    ...
    :param ignore_exception: enable warnings on ignored exceptions
    :param wrapper_kls: wrapper class target
...
class ParamSignatures(Enum):
    locator = "locator"
    locator_type = "locator_type"
    by_locator = "locator_type"
    text = "text"
