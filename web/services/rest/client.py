...
from web.services.core.clients.raw_rest_client import RawRestClient
from web.services.core.contracts.interfaces import *
from web.services.rest.response import *
...
class BaseWebClient(IWebClient, RawRestClient):
    ...
    def __init__(self, base_url: str, **kwargs):
        ...
        super(BaseWebClient, self).__init__(base_url, self.__verify_ssh, self.__response_encoding)
        self.initialize()
    ...
    def execute(self, request_object: IWebServiceRequest, type_hook: Type[T], **kwargs) -> IResponse[T]:
    ...
    def _parse_response_(self, response: requests.Response, type_hook: Type[T]) -> IResponse[T]:

        result = Response(type_hook,
                          data=None,
    ...
    def _execute_request(self, request_obj: IWebServiceRequest, **kwargs) -> requests.Response:
