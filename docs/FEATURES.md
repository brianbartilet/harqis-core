...
- Please refer to the [README.md](../README.md#use-cases) for more information on the framework and its use cases.
### Development Status
...
| :arrow_forward: **BDD behave**  | Utilities to enhance BDD test development using [behave](https://behave.readthedocs.io/en/stable/).                                                                                                                                   |                                                                            |

### Test Automation Fixtures
- Please see fixtures [README.md](../core/web/README.md#fixtures) documentation for more details of provided test fixtures.
...
- Refer to this [README.md](../core/web/README.md#mocking) for additional information
