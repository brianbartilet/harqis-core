...
from playwright.async_api import \
    ...
    Keyboard as PlaywrightKeyboard, \
    Error as PlaywrightError

# TypeVars are more useful for generic classes and functions
TElement = Union[SeleniumWebElement, ]
TLocator = Union[SeleniumBy, ]
TKeyboard = Union[SeleniumKeys, ]
TException = Union[SeleniumExceptions, ]
